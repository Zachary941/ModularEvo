...
if [[ ${SUB_TASK} == none ]]; then
  OUTPUT_DIR=${MODEL_DIR}_lota/${TASK}/${FULL_MODEL_TAG}
else
  OUTPUT_DIR=${MODEL_DIR}_lota/${TASK}/${SUB_TASK}/${FULL_MODEL_TAG}
fi
