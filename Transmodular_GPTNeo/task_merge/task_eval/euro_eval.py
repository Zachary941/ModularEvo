...
def evaluate_euro_model(model: GPTNeoWithClassificationHead) -> dict:
    """Main function for training and evaluating the model"""
    # Set random seed
    set_seed(42)
    
    # Prepare dataset
    tokenized_datasets, tokenizer, num_labels = prepare_langid_dataset()
    ...
    # Run evaluation
    results = evaluator.evaluate(tokenized_datasets['test'])
