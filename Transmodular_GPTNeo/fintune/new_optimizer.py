            ...
            if self.mask_dict:
                ...
                for p in group['params']:
                    ...
                    if self.mask_dict is not None and mask_name in self.mask_dict:
                        ...
                        # print(f"Applying mask to {p.grad.data}")
                        p.grad.data *= bin_mask
                        # print(f"Mask applied to {p.grad.data}")
                    grads.append(p.grad)
                    params_with_grad.append(p)
                # print(f"Grads: {grads}")
...
AdamWS.__doc__ = r"""Implements AdamW algorithm.
