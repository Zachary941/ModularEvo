...
def merge_models(model1, model2, stage, model_base_path, 
    ...
    # # Save merged model
    # output_path = f"TransModular_GPT/task_merge/longrun/mask_finetune_{stage}/"
...
def merge1(args):
    ...
    if args.type == 1:
        ...
        torch.save(model_math.state_dict(), "TransModular_GPT/task_merge/longrun/mask_finetune_0/model_merge_math0_full.bin")
        torch.save(model_law.state_dict(), "TransModular_GPT/task_merge/longrun/mask_finetune_0/model_merge_law0_full.bin")
    else:
        torch.save(model_math.state_dict(), "TransModular_GPT/task_merge/longrun/mask_finetune_0/model_merge_math0_mask.bin")
        torch.save(model_law.state_dict(), "TransModular_GPT/task_merge/longrun/mask_finetune_0/model_merge_law0_mask.bin")
...
def merge2(args):
    ...
    if args.type == 1:
        logger.info('======================math====================')
        model_math = GPTNeoWithClassificationHead(model_name_or_path, num_classes=25)
        # model_math.load_state_dict(torch.load("TransModular_GPT/task_merge/longrun/mask_finetune_0/mathqa_stage1_full/lr5e-05_bs8_e2_p3/best_model/pytorch_model.bin"))
        model_math.load_state_dict(torch.load("TransModular_GPT/task_merge/longrun/mask_finetune_0/mathqa_stage1_full/lr5e-05_bs8_e4_p20/checkpoint-5836/pytorch_model.bin"))
        logger.info('======================law====================')
        model_law = GPTNeoWithClassificationHead(model_name_or_path, num_classes=13)
        # model_law.load_state_dict(torch.load("TransModular_GPT/task_merge/longrun/mask_finetune_0/scotus_stage1_full/lr5e-05_bs8_e4_p4/best_model/pytorch_model.bin"))
        model_law.load_state_dict(torch.load("TransModular_GPT/task_merge/longrun/mask_finetune_0/scotus_stage1_full/lr5e-05_bs8_e4_p20/checkpoint-836/pytorch_model.bin"))
        merged_params =merge_models(model_math, model_law, 0, model_name_or_path, num_classes1=25, num_classes2=13, method="task_arithmetic", coef1=args.alpha1, coef2=args.alpha2, exclude_patterns=None)
    else :
        logger.info('======================math====================')
        model_math = GPTNeoWithClassificationHead(model_name_or_path, num_classes=25)
        model_math.load_state_dict(torch.load("TransModular_GPT/task_merge/longrun/mask_finetune_0/mathqa_stage1_mask/lr5e-05_bs8_e2_p8/best_model/pytorch_model.bin"))

        logger.info('======================law====================')
        model_law = GPTNeoWithClassificationHead(model_name_or_path, num_classes=13)
        model_law.load_state_dict(torch.load("TransModular_GPT/task_merge/longrun/mask_finetune_0/scotus_stage1_mask/lr5e-05_bs8_e6_p6/best_model/pytorch_model.bin"))
        merged_params =merge_models(model_math, model_law, 0, model_name_or_path, num_classes1=25, num_classes2=13, method="task_arithmetic", coef1=args.alpha1, coef2=args.alpha2, exclude_patterns=None)
    ...
    print(result_law)
    if args.type == 1:
        torch.save(model_math.state_dict(), "TransModular_GPT/task_merge/longrun/mask_finetune_0/model_merge_math1_full.bin")
        torch.save(model_law.state_dict(), "TransModular_GPT/task_merge/longrun/mask_finetune_0/model_merge_law1_full.bin")
    else:
        torch.save(model_math.state_dict(), "TransModular_GPT/task_merge/longrun/mask_finetune_0/model_merge_math1_mask.bin")
        torch.save(model_law.state_dict(), "TransModular_GPT/task_merge/longrun/mask_finetune_0/model_merge_law1_mask.bin")
